...
@Component({
  selector: 'app-my-routers',
  templateUrl: './my-routers.component.html',
  styleUrls: ['./my-routers.component.css']
})
export class MyRoutersComponent{
  ...
  public tableSource: TableHelper<IRouter> = new TableHelper(this.columnList, 10, this.httpSvc, this.url);
  ...
  edit(id: string) {
    ...
    this.route.navProjectRouterDetail(id, data)
  }
  create() {
    this.route.navProjectNewRouterDetail()
  }
