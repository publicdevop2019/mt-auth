export const zhHans = {
    ...
    "PLS_ENTER_PROJECT_NAME": "请输入项目名称(至少5个字符)",
    ...
    "TYPE_MIXED_APP": "传统的Web应用，例如：Node.js, Express, Java, PHP, ASP.NET",
    "TYPE_FRONTEND_APP": "纯前端应用，例如：Angular, React, Vue",
    "ENTER_CLIENT_NAME": "请输入应用名称（至少5个字符）",
