...
export interface ISearchConfig {
  ...
  resumeFromUrl?: (searchCmpt: TenantSearchComponent, queryValue: string) => void
}
@Component({
...
export class TenantSearchComponent implements OnDestroy, OnInit, OnChanges {
  ...
  ngOnInit(): void {
    //cannot bind at constructor due to emit not catch by parent
