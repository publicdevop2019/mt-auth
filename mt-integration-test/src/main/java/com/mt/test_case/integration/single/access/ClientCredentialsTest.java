...
public class ClientCredentialsTest  extends CommonTest {
    ...
    public void use_client_with_secret() {
        ResponseEntity<DefaultOAuth2AccessToken> tokenResponse =
            OAuth2Utility.getOAuth2WithClient(AppConstant.GRANT_TYPE_CLIENT_CREDENTIALS, AppConstant.CLIENT_ID_OAUTH2_ID,
    ...
    public void use_client_with_empty_secret() {
        ResponseEntity<DefaultOAuth2AccessToken> tokenResponse =
            OAuth2Utility.getOAuth2WithClient(AppConstant.GRANT_TYPE_CLIENT_CREDENTIALS, AppConstant.CLIENT_ID_REGISTER_ID,
    ...
    public void use_client_with_wrong_grant_type() {
        ResponseEntity<DefaultOAuth2AccessToken> tokenResponse =
            OAuth2Utility.getOAuth2WithClient(AppConstant.GRANT_TYPE_PASSWORD, AppConstant.CLIENT_ID_OAUTH2_ID,
                AppConstant.COMMON_CLIENT_SECRET);
        Assert.assertEquals(HttpStatus.UNAUTHORIZED, tokenResponse.getStatusCode());
    ...
    public void trying_to_login_with_not_exist_client() {
        ResponseEntity<DefaultOAuth2AccessToken> tokenResponse =
            OAuth2Utility.getOAuth2WithClient(AppConstant.GRANT_TYPE_PASSWORD, UUID.randomUUID().toString(),
